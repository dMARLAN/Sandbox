...
public class Solution {
    ...
    public static void main(String[] args){
        ...
        System.out.println(numberToWords(123)); // expected "One Hundred Twenty Three"
        System.out.println(numberToWords(12345)); // expected "Twelve Thousand Three Hundred Forty Five"
        System.out.println(numberToWords(1234567)); // expected "One Million Two Hundred Thirty Four Thousand Five Hundred Sixty Seven"
    }
